...
class _uselessState extends State<useless> {
  ...
  // List<String> memberList = ['Teacher', 'Student'];
  @override
...
//                       children: [
//                         Text(selectOption),
//                         Icon(isOpen? Icons.keyboard_arrow_up_outlined:Icons.keyboard_arrow_down),
//                       ],
//                     ),
//                   ),
//                 ),
...
//   @override
//   State<useless> createState() => _CustomDropDownWidgetState();
// }

// class _CustomDropDownWidgetState extends State<useless> {
